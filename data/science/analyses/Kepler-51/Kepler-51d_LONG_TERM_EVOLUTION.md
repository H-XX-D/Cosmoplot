...
**Binding Energy per H Atom**: E_b ≈ **197481546735817949184 meV**
...
Kepler-51d's escape parameter of 2.6 indicates weak gravitational binding, meaning the planet's gravity cannot adequately retain its hydrogen envelope.
...
Substituting values:
$$\dot{M} \approx 0.01 \times \frac{75 \times 6.24 \times 10^{11}}{{be:.0f}} \times 4\pi \times (1.89 R_J)^2$$
...
The binding energy E_b = 197481546735817949184 meV represents the gravitational potential well depth per hydrogen atom. This determines how much thermal energy is needed to escape:

**Energy Balance:**
- Thermal energy available: E_th = 3k_B T_exobase ≈ 0 meV
- Binding energy required: E_b = 197481546735817949184 meV
