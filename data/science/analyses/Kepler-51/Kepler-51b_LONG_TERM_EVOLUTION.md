...
The physically meaningful thermal-escape diagnostic is the Jeans parameter lambda_J = (3/2)(v_esc/v_th)^2 = **36**. Jeans escape is negligible for lambda_J >~ 15 (thermally bound) and only becomes hydrodynamic blow-off for lambda_J <~ 2-3. Close-in giants therefore lose mass mainly through XUV-driven energy-limited escape, not thermal Jeans escape.

**Escape energy per H atom**: E_b = 1/2 m_H v_esc^2 = **1682 meV** (1.68 eV)

For comparison the mean thermal energy is E_th = 3k_B T = 140 meV, far below the escape energy, confirming the atmosphere is thermally bound.

Kepler-51b's Jeans escape parameter is lambda_J = (3/2)(v_esc/v_th)^2 = 36 (>> 15), so thermal (Jeans) escape is negligible and the planet retains its hydrogen envelope; any loss proceeds through XUV-driven energy-limited escape and is modest over Gyr timescales.
...
Substituting values:
$$\dot{M} \approx 0.03 \times \frac{180 \times 6.24 \times 10^{11}}{1.7} \times 4\pi \times (0.99 R_J)^2$$
...
The binding energy E_b = 1/2 m_H v_esc^2 ≈ 1682 meV represents the gravitational potential well depth per hydrogen atom. This determines how much thermal energy is needed to escape:

**Energy Balance:**
- Thermal energy available: E_th = 3k_B T ≈ 140 meV
- Escape energy per H: E_b = 1/2 m_H v_esc^2 ≈ 1682 meV
- Ratio: E_th/E_b = 0.083 (<<1 strongly bound)
