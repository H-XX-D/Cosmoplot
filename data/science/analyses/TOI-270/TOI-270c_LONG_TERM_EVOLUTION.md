# TOI-270c Long-Term Evolution Projection

## 1. Current State Summary

### Planetary Parameters and Classification

TOI-270c is a Neptune-like with distinctive characteristics that shape its evolutionary trajectory. With a mean density of 1.820 g/cm³, it occupies a unique position in the density-temperature phase space of exoplanet atmospheres, directly influencing how stellar radiation impacts its long-term atmospheric stability.

**Fundamental Properties:**
- **Mass**: 0.101 M_J (equivalently 32.1 M_E)
- **Radius**: 0.516 R_J (5.81 R_E)
- **Mean Density**: ρ = 1.820 g/cm³
- **Equilibrium Temperature**: T_eq = 489 K
- **Orbital Period**: 5.71 days
- **Semi-major Axis**: a = 0.0443 AU
- **Host Star**: M2.5V dwarf (T_eff = 3600 K, L★ = 0.038 L☉)
- **Stellar XUV Flux**: F_XUV ≈ 40 erg/s/cm²
- **Atmospheric Scale Height**: H ≈ 2.2 km

### Current Atmospheric Characteristics

TOI-270c's current atmosphere represents the primordial or evolved state depending on its age and history. The planet maintains a hydrogen-dominated envelope with trace heavier species that provide valuable spectroscopic signatures.
...
- **Estimated Atmospheric Mass**: ≈ 0.0005 M_J

**Atmospheric Dynamics:**
- **Scale Height**: 2.2 km (determines transit spectroscopy depth)
...
Surface gravity at 0.516 R_J: g = 9.8 m/s²

Escape velocity: v_esc = √(2GM/R) = **26.63 km/s**

Thermal velocity at 489 K: v_th = √(3k_B T/m_H) = **3.482 km/s**

**Escape Parameter**: λ = v_esc / v_th = **7.6**

The physically meaningful thermal-escape diagnostic is the Jeans parameter lambda_J = (3/2)(v_esc/v_th)^2 = **88**. Jeans escape is negligible for lambda_J >~ 15 (thermally bound) and only becomes hydrodynamic blow-off for lambda_J <~ 2-3. Close-in giants therefore lose mass mainly through XUV-driven energy-limited escape, not thermal Jeans escape.

**Escape energy per H atom**: E_b = 1/2 m_H v_esc^2 = **3702 meV** (3.70 eV)

For comparison the mean thermal energy is E_th = 3k_B T = 126 meV, far below the escape energy, confirming the atmosphere is thermally bound.

TOI-270c's Jeans escape parameter is lambda_J = (3/2)(v_esc/v_th)^2 = 88 (>> 15), so thermal (Jeans) escape is negligible and the planet retains its hydrogen envelope; any loss proceeds through XUV-driven energy-limited escape and is modest over Gyr timescales.
...
Over the first billion years, TOI-270c experiences atmospheric erosion primarily through XUV photoevaporation. The dominant mechanism depends on the planet's balance between stellar heating and gravitational binding.
...
1. **Ionization**: Stellar EUV photons (10-100 nm) ionize neutral hydrogen atoms
   ...
   - XUV flux received: F_XUV = 40 erg/s/cm²
...
Substituting values:
$$\dot{M} \approx 0.03 \times \frac{40 \times 6.24 \times 10^{11}}{3.7} \times 4\pi \times (0.516 R_J)^2$$
...
- Initial atmospheric mass: 0.0005 M_J
- Percentage lost: 0.03%
- Mass lost: 0.0000 M_J
- Remaining atmosphere: 0.0005 M_J (100.0% retained)

**Radius Evolution:**
- Initial radius: 0.516 R_J
- Radius contraction rate: 0.0000 R_J per Gyr
- Radius after 1 Gyr: 0.516 R_J
...
- Scale height: Remains approximately 2.2 km (temperature-dependent, not mass-dependent)
...
**Density Evolution:**
- Current density: 1.820 g/cm³
- Density at 5 Gyr: 1.820 g/cm³ (0.0% increase)
...
- Escape parameter now: λ ≈ 7.4 (slight decline from 7.6)
...
At 10 billion years, TOI-270c's atmosphere reaches an approximately equilibrial state. The escape rate becomes negligible and the atmosphere stabilizes.
...
- Final radius: 0.516 R_J (down 0.0%)
- Final mass: 0.101 M_J (essentially unchanged)
- Final density: 1.820 g/cm³
...
TOI-270c will **very slowly continue eroding its atmosphere** beyond 10 Gyr.

### Evolutionary Category and Final Fate

TOI-270c falls into the **Actively Eroding** evolutionary category.
...
Ionization leaves behind energetic photoelectrons that dissipate energy through collisions, heating the local atmosphere from ≈600 K to ≈989 K. This heating causes thermal expansion.

**Stage 3: Hydrodynamic Expansion**
The heated atmosphere expands, creating a density gradient that drives outflow. The escape velocity 26.63 km/s competes with the thermal velocity 3.482 km/s. Since v_esc >> v_th (escape parameter 7.6), gravity moderately constrains the flow.
...
The binding energy E_b = 1/2 m_H v_esc^2 ≈ 3702 meV represents the gravitational potential well depth per hydrogen atom. This determines how much thermal energy is needed to escape:

**Energy Balance:**
- Thermal energy available: E_th = 3k_B T ≈ 126 meV
- Escape energy per H: E_b = 1/2 m_H v_esc^2 ≈ 3702 meV
- Ratio: E_th/E_b = 0.034 (<<1 strongly bound)
...
TOI-270c's density of 1.820 g/cm³ places it in the high-density category.
...
4. **Density**: 1.820 g/cm³
   - Moderate density → strong gravity → good retention

### Expected Final State and Observational Consequences

**By 10 Gyr, TOI-270c will exhibit:**

1. **Radius Change**: 0.516 R_J → 0.516 R_J (0.0% shrinkage)
...
4. **Comparative Evolution**: TOI-270c's evolution rate is among the slowest in its temperature class

---

## Conclusion

TOI-270c represents a template for active atmospheric erosion among exoplanet atmospheres. Its 10 billion year trajectory demonstrates how the interplay between stellar heating (40 erg/s/cm²), planetary gravity (λ = 7.6), and initial mass (0.0005 M_J) determines long-term atmospheric fate.

**Key Takeaways:**

1. **Escape Parameter Dominance**: The escape parameter λ = 7.6 is the single best predictor of TOI-270c's evolutionary path

2. **Asymptotic Stability**: After 5-10 Gyr, the escape rate becomes negligible, and the atmosphere stabilizes

3. **Density-Gravity Coupling**: TOI-270c's density of 1.820 g/cm³ creates extraordinarily strong gravitational retention
...
For exoplanet scientists, TOI-270c provides a clear example of how vulnerable planets can be to atmospheric erosion. JWST observations over coming years will test these predictions and refine our understanding of long-term exoplanet evolution.
