# TOI-5205b Long-Term Evolution Projection

## 1. Current State Summary

### Planetary Parameters and Classification

TOI-5205b is a Neptune-like with distinctive characteristics that shape its evolutionary trajectory. With a mean density of 2.250 g/cm³, it occupies a unique position in the density-temperature phase space of exoplanet atmospheres, directly influencing how stellar radiation impacts its long-term atmospheric stability.

**Fundamental Properties:**
- **Mass**: 1.080 M_J (equivalently 343.0 M_E)
- **Radius**: 1.040 R_J (11.60 R_E)
- **Mean Density**: ρ = 2.250 g/cm³
- **Equilibrium Temperature**: T_eq = 737 K
- **Orbital Period**: 2.42 days
- **Semi-major Axis**: a = 0.0199 AU
- **Host Star**: M4V dwarf (T_eff = 3430 K, L★ = 0.0194 L☉)
- **Stellar XUV Flux**: F_XUV ≈ 75 erg/s/cm²
- **Atmospheric Scale Height**: H ≈ 1.1 km

### Current Atmospheric Characteristics

TOI-5205b's current atmosphere represents the primordial or evolved state depending on its age and history. The planet maintains a hydrogen-dominated envelope with trace heavier species that provide valuable spectroscopic signatures.
...
- **Estimated Atmospheric Mass**: ≈ 0.0054 M_J

**Atmospheric Dynamics:**
- **Scale Height**: 1.1 km (determines transit spectroscopy depth)
- **Escape Status**: Essentially primordial - minimal atmospheric loss
- **Mach Number** (at exobase): 1.0-1.9 (controls flow regime)
...
Surface gravity at 1.040 R_J: g = 25.9 m/s²

Escape velocity: v_esc = √(2GM/R) = **61.34 km/s**

Thermal velocity at 737 K: v_th = √(3k_B T/m_H) = **4.274 km/s**

**Escape Parameter**: λ = v_esc / v_th = **14.4**

The physically meaningful thermal-escape diagnostic is the Jeans parameter lambda_J = (3/2)(v_esc/v_th)^2 = **309**. Jeans escape is negligible for lambda_J >~ 15 (thermally bound) and only becomes hydrodynamic blow-off for lambda_J <~ 2-3. Close-in giants therefore lose mass mainly through XUV-driven energy-limited escape, not thermal Jeans escape.

**Escape energy per H atom**: E_b = 1/2 m_H v_esc^2 = **19640 meV** (19.64 eV)

For comparison the mean thermal energy is E_th = 3k_B T = 191 meV, far below the escape energy, confirming the atmosphere is thermally bound.

TOI-5205b's Jeans escape parameter is lambda_J = (3/2)(v_esc/v_th)^2 = 309 (>> 15), so thermal (Jeans) escape is negligible and the planet retains its hydrogen envelope; any loss proceeds through XUV-driven energy-limited escape and is modest over Gyr timescales.
...
Over the first billion years, TOI-5205b experiences atmospheric erosion primarily through XUV photoevaporation. The dominant mechanism depends on the planet's balance between stellar heating and gravitational binding.
...
Substituting values:
$$\dot{M} \approx 0.07 \times \frac{75 \times 6.24 \times 10^{11}}{19.6} \times 4\pi \times (1.04 R_J)^2$$
...
- Initial atmospheric mass: 0.0054 M_J
- Percentage lost: 0.08%
- Mass lost: 0.0000 M_J
- Remaining atmosphere: 0.0054 M_J (99.9% retained)

**Radius Evolution:**
- Initial radius: 1.040 R_J
- Radius contraction rate: 0.0000 R_J per Gyr
- Radius after 1 Gyr: 1.040 R_J
...
- Scale height: Remains approximately 1.1 km (temperature-dependent, not mass-dependent)
...
**Density Evolution:**
- Current density: 2.250 g/cm³
- Density at 5 Gyr: 2.250 g/cm³ (0.0% increase)
...
- Escape parameter now: λ ≈ 13.9 (slight decline from 14.4)
...
At 10 billion years, TOI-5205b's atmosphere reaches an approximately equilibrial state. The escape rate becomes negligible and the atmosphere stabilizes.
...
- Final radius: 1.040 R_J (down 0.0%)
- Final mass: 1.080 M_J (essentially unchanged)
- Final density: 2.250 g/cm³
...
TOI-5205b will **indefinitely retain its atmosphere** beyond 10 Gyr.

### Evolutionary Category and Final Fate

TOI-5205b falls into the **Primordial Retainer** evolutionary category.
...
Ionization leaves behind energetic photoelectrons that dissipate energy through collisions, heating the local atmosphere from ≈600 K to ≈1237 K. This heating causes thermal expansion.

**Stage 3: Hydrodynamic Expansion**
The heated atmosphere expands, creating a density gradient that drives outflow. The escape velocity 61.34 km/s competes with the thermal velocity 4.274 km/s. Since v_esc >> v_th (escape parameter 14.4), gravity strongly constrains the flow.
...
The binding energy E_b = 1/2 m_H v_esc^2 ≈ 19640 meV represents the gravitational potential well depth per hydrogen atom. This determines how much thermal energy is needed to escape:

**Energy Balance:**
- Thermal energy available: E_th = 3k_B T ≈ 191 meV
- Escape energy per H: E_b = 1/2 m_H v_esc^2 ≈ 19640 meV
- Ratio: E_th/E_b = 0.010 (<<1 strongly bound)
...
**Density Comparison:**
- TOI-5205b: 2.250 g/cm³
- Jupiter: 1.33 g/cm³
- Saturn: 0.687 g/cm³
- Neptune: 1.64 g/cm³
- Earth: 5.52 g/cm³

TOI-5205b's density of 2.250 g/cm³ places it in the high-density category.
...
### Why TOI-5205b Evolves as Predicted

**Key Evolutionary Drivers:**

1. **Escape Parameter**: λ = 14.4
   - Controls atmospheric retention: Perfect retention expected
...
4. **Density**: 2.250 g/cm³
   - Moderate density → strong gravity → good retention

### Expected Final State and Observational Consequences

**By 10 Gyr, TOI-5205b will exhibit:**

1. **Radius Change**: 1.040 R_J → 1.040 R_J (0.0% shrinkage)
...
3. **Stability**: Essentially permanent - no further observable change expected

4. **Comparative Evolution**: TOI-5205b's evolution rate is among the slowest in its temperature class

---

## Conclusion

TOI-5205b represents a stable archetype for primordial atmosphere preservation among exoplanet atmospheres. Its 10 billion year trajectory demonstrates how the interplay between stellar heating (75 erg/s/cm²), planetary gravity (λ = 14.4), and initial mass (0.0054 M_J) determines long-term atmospheric fate.

**Key Takeaways:**

1. **Escape Parameter Dominance**: The escape parameter λ = 14.4 is the single best predictor of TOI-5205b's evolutionary path

2. **Asymptotic Stability**: After 5-10 Gyr, the escape rate becomes negligible, and the atmosphere stabilizes

3. **Density-Gravity Coupling**: TOI-5205b's density of 2.250 g/cm³ creates extraordinarily strong gravitational retention

4. **Observable Evolution**: Subtle radius and composition changes expected over decade-timescales with precision spectroscopy

For exoplanet scientists, TOI-5205b provides a critical reference for understanding primordial atmosphere preservation in low-density planets. JWST observations over coming years will test these predictions and refine our understanding of long-term exoplanet evolution.
